...
var projectPath = {
  ...
  src: {
    html: 'src/*.html',
    htmlTemplate: 'src/templates/template.html',
    jsCustom: 'src/js/jquery-ready.js',
...
gulp.task('html', function() {
  console.log(projectPath.src.htmlTemplate)
  return gulp.src(projectPath.src.html)
    .pipe(template(projectPath.src.htmlTemplate))
...
gulp.task('watch',['webserver'], function(){
  ...
  watch([projectPath.watch.htmlTemplate], function(event, cb) {
    gulp.start('html');
  });
